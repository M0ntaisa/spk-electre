                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-8">
                                                                    <div class="login-btn-inner">
                                                                        <?php if ($cek < 2) { ?>
                                                                            <button class="btn btn-sm btn-danger form-control" type="submit" title="Data Minimal 2." disabled><i class="fa fa-times"></i> Data Alternatif Tidak Mencukupi Untuk Diproses</button>
                                                                        <?php } else { ?>
                                                                            <button class="btn btn-sm btn-primary form-control" type="submit"><i class="fa fa-flask"></i> Proses</button>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                            </div>
