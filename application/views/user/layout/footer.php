...
<!-- </div> -->
    ...
    <!-- touchspin JS
		============================================ -->
    <script src="<?= base_url(); ?>assets/templates/admin/js/touchspin/jquery.bootstrap-touchspin.min.js"></script>
    <script src="<?= base_url(); ?>assets/templates/admin/js/touchspin/touchspin-active.js"></script>
    <!-- datapicker JS
		============================================ -->
    <script src="<?= base_url(); ?>assets/templates/admin/js/datapicker/bootstrap-datepicker.js"></script>
    <script src="<?= base_url(); ?>assets/templates/admin/js/datapicker/datepicker-active.js"></script>
    <!-- sticky JS
		============================================ -->
