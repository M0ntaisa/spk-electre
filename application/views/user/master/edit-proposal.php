...
<button type="button" class="form-control btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-proposal">
    <i class="fa fa-edit"></i> Edit Proposal
</button>

<div id="edit-proposal" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
