...
<button type="button" class="form-control btn btn-primary btn-sm" data-toggle="modal" data-target="#add-akta-notaris">
    <i class="fa fa-plus"></i> Tambah Akta Notaris
</button>

<div id="add-akta-notaris" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
