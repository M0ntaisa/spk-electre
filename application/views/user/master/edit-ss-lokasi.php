...
<button type="button" class="form-control btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-ss-lokasi">
    <i class="fa fa-edit"></i> Edit Screenshot Lokasi Kandang
</button>

<div id="edit-ss-lokasi" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
