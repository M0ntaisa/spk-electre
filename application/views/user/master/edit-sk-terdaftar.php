...
<button type="button" class="form-control btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-sk-terdaftar">
    <i class="fa fa-edit"></i> Edit Surat Keterangan Terdaftar
</button>

<div id="edit-sk-terdaftar" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
