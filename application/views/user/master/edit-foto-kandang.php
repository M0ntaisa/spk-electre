...
<button type="button" class="form-control btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-foto-kandang">
    <i class="fa fa-edit"></i> Edit Foto Kandang
</button>

<div id="edit-foto-kandang" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
