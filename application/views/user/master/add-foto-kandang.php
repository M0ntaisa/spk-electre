...
<button type="button" class="form-control btn btn-primary btn-sm" data-toggle="modal" data-target="#add-foto-kandang">
    <i class="fa fa-plus"></i> Tambah Foto Kandang
</button>

<div id="add-foto-kandang" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
