...
<button type="button" class="form-control btn btn-primary btn-sm" data-toggle="modal" data-target="#add-ss-lokasi">
    <i class="fa fa-plus"></i> Tambah Screenshot Lokasi Kandang
</button>

<div id="add-ss-lokasi" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
