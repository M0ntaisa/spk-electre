...
<button type="button" class="form-control btn btn-warning btn-sm" data-toggle="modal" data-target="#edit-akta-pengukuhan">
    <i class="fa fa-edit"></i> Edit Akta Pengukuhan
</button>

<div id="edit-akta-pengukuhan" class="modal modal-adminpro-general modal-zoomInDown fade" role="dialog">
